...
class RegisterRepository implements RepositoryInterface
{
    ...
    public function update($data,$id)
    {
        ...
        $model = new Register();
        $find = Register::where($this->primaryKey,"=",$id)->first();
    ...
    public function delete($id)
    {
        ...
        try {
            ...
            $res = Register::where($this->primaryKey, $id)->delete();
    ...
    public function getData($query_string = array())
    {
        ...
        $data = Register::orderBy($sortBy,$sortOrder);
    ...
    {
        if (!$limit) {
            $data = Register::limit($limit)->orderBy($this->orderBy[0],$this->orderBy[1])
            ->get()->toArray();
        } else {
            $data = Register::orderBy($this->orderBy[0],$this->orderBy[1])->get()->toArray();
        }
    ...
    {
        $res = Register::where($this->primaryKey,"=",$id)->first();
